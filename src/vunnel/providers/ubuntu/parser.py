...
class Parser:
    ...
    def _clean_input(self) -> None:
        """Remove input directories nothing reads any more. Silent and idempotent.

        Four of them, all one-time. `ubuntu-cve-tracker` was the cloned security
        tracker repo and `distro-info` a fetched release calendar. The other
        three were the re-encoding of the two feeds and the snapshot into
